...
// #define WATCHDOG_TRIGGER_GPIO	18
// #define CONFIG_WATCHDOG_TIMEOUT_MSECS 1000
...
#define BOOTENV \
	...
	"devtype=mmc\0" \
	"devnum=0\0" \
	"bootargs=8250.nr_uarts=1 console=tty1 console=ttyAMA0,115200 earlyprintk=ttyS0,115200\0" \
	"bootcmd=load ${devtype} ${devnum}:${distro_bootpart} ${scriptaddr} ${script}; source ${scriptaddr}\0" \
	"rootfs_bootargs=8250.nr_uarts=1 rootwait init=/usr/sbin/overlay_root.sh console=tty1 console=ttyAMA0,115200 earlyprintk=ttyS0,115200\0" \
	"recovery_bootargs=8250.nr_uarts=1 console=tty1 console=ttyAMA0,115200 earlyprintk=ttyS0,115200"
